...
from tests.functional.extension_functions.testcase_parameters.logarithmic_tests import (
    SCALAR_FUNCTIONS)
from tests.parametrization import custom_parametrization

from ...producers import produce_duckdb_substrait
...
class TestLogarithmicFunctions:
    ...
    def test_duckdb_consumer(
        ...
        logarithmic functions produced by different producers.
